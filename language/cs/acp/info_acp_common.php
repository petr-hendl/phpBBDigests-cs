...
$lang = array_merge($lang, array(
	...
	'ACP_DIGESTS_CLEAR_CACHED_DIGESTS'						=> 'Vymazat uložené souhrny a statistiky',
	'ACP_DIGESTS_CLEAR_CACHED_DIGESTS_EXPLAIN'				=> 'Tato stránka vám umožní smazat uložené souhry ve složce /store/phpbbservices/digests. Ty jsou vytvořené ručním spouštěním rozesílače emailů a mohou představovat potenciální bezpečnostní riziko. Pokud jsou zde zobrazeny nějaké soubory, doporučujeme jejich odstranění.<br><br>Celkem je uloženo %1$d souborů. Jména souborů: %2$s.<br><br>Můžete také vymazat ukládané statistiky.',
	'ACP_DIGESTS_GENERAL_SETTINGS'							=> 'Obecná nastavení',
	'ACP_DIGESTS_GENERAL_SETTINGS_EXPLAIN'					=> 'Toto jsou obecná nastavení Souhrnů e-mailem. Pokud chcete dosáhnout včasné doručení souhrnů emailem, musíte ve vašem fóru povolit <a href="https://www.phpbb.com/customise/db/extension/digests_extension/faq/2716">systémový cron</a>. Jinak jsou souhrny vygenerovány a poslány jen v okamžiku provozu na fóru. Pro více informací se podívejte na <a href="https://www.phpbb.com/customise/db/extension/digests_extension/faq">Časté dotazy (FAQ) k rozšíření Digests (Souhrny emailem)</a>.',
	...
	'ACP_DIGESTS_REPORTS'									=> 'Zpráva o rozesílání',
	'ACP_DIGESTS_REPORTS_EXPLAIN'							=> 'Tato stránka zobrazuje informace o rozesílání souhrnů pro proběhlé dny a hodiny, včetně informací o výkonu. Tabulku můžete třídit kliknutím na záhlaví sloupce. Po kliknutí na hodnotu zaslaných nebo vynechaných souhrnů se zobrazí detaily o zaslání nebo vynechání pro odběratele dané hodiny.',
	...
	'LOG_CONFIG_DIGESTS_CLEAR_REPORT'						=> '<strong>Smazána statistika rozesílání souhrnů</strong>',
	...
	'LOG_CONFIG_DIGESTS_EMAILING_FAILURE'					=> '<strong>Nepodařilo se odeslat souhrn pro den %1$s a hodinu %2$d UTC. Doba běhu: %3$s z %4$d povolených vteřin. Bylo použito %5$s MB paměti. Celkem bylo zasláno %6$u souhrnů, %7$u bylo vynecháno a %8$u hodin bylo zpracováno, než bylo rozesílání přerušeno.</strong>',
	'LOG_CONFIG_DIGESTS_EMAILING_SUCCESS'					=> '<strong>Souhrny pro den %1$s a hodinu %2$d UTC (GMT) byly zaslány. Doba běhu: %3$s z %4$d povolených vteřin. Bylo použito %5$s MB paměti. Celkem bylo zasláno %6$u souhrnů, %7$u bylo vynecháno a %8$u hodin bylo zpracováno.</strong>',
    ...
    'LOG_CONFIG_DIGESTS_LOG_END'							=> '<strong>Rozesílač souhrnů končí. Bylo zasláno %1$u souhrnů a %2$u souhrnů bylo vynecháno.</strong>',
	...
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD'						=> array(
																1 => '<strong>Souhrn %1$s byl %2$s pro %3$s (%4$s) pro den %5$s a hodinu %6$02d UTC. Obsahuje %7$d příspěvků a %8$d soukromých zpráv.</strong>',
																2 => '<strong>Souhrn %1$s byl %2$s pro %3$s (%4$s) pro den %5$s a hodinu %6$02d UTC. Obsahuje %7$d příspěvků a %8$d soukromých zpráv.</strong>',
																3 => '<strong>Souhrn %1$s byl %2$s pro %3$s (%4$s) pro den %5$s a hodinu %6$02d UTC. Obsahuje %7$d příspěvků a %8$d soukromých zpráv.</strong>',
															),
	...
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD_NO_EMAIL'			=> array(
																1 => '<strong>Souhrn %1$s byl %2$s pro %3$s pro den %4$s a hodinu %5$02d UTC. Obsahuje %6$d příspěvků a %7$d soukromých zpráv.</strong>',
																2 => '<strong>Souhrn %1$s byl %2$s pro %3$s pro den %4$s a hodinu %5$02d UTC. Obsahuje %6$d příspěvků a %7$d soukromých zpráv.</strong>',
																3 => '<strong>Souhrn %1$s byl %2$s pro %3$s pro den %4$s a hodinu %5$02d UTC. Obsahuje %6$d příspěvků a %7$d soukromých zpráv.</strong>',
															),
